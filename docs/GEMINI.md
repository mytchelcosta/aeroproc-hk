...
Our core goal is to create an insctructional tool to help Air Traffic Controllers to train and know published procedures for arrival, approach, and departure in Hong Kong TMA.
...
4. Once I approve the stack, design the logic and write a step-by-step technical blueprint into a file called `docs/implementation_plan.md`.
